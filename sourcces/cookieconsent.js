...
var cc =
{
    ...
    settings: {
        ...
        useSSL: true,
        serveraddr: 'https://www.analytics-sem-tutorials.de',
        clearprefs: false,
    ...
    strings: {
        ...
        socialDefaultDescription: "Facebook, Twitter und andere Netzwerke möchten wissen wo Sie sich befinden um Webung zu schalten.",
    ...
    showbanner: function () {
        ...
        ccdata = '<div id="cc-notification">' +
            '<div id="cc-notification-wrapper">' +
            '<h2><span id="cc-notification-wrapper-h2">' + cc.strings.notificationTitle + '</span></h2>' +
            ...
            '</li>' +
			'<li>' +
            '<a class="cc-link" href="#" id="cc-disapprove-button-thissite">' + cc.strings.disallowCookies + '</a>' +
            '</li>' +
			'</ul>' +
		...
		if(cc.settings.bannerPosition =="cc-TopOld"){
		jQuery('#cc-notification-wrapper h2').append(' - <a id="cc-dataPrivacy" class="cc-dataPrivacy" target="_blank" href="' + cc.strings.privacyPolicyLink +'">' + cc.strings.privacyPolicyText + '</a> ');
        }
		if(cc.settings.bannerPosition !="cc-TopOld"){

;(function(document, window, config) {
  ...
  'non_interaction': true
    ...
    } else if (typeof window[_gtag] === 'function' && 
              typeof window[_gtag].getAll === 'function' && 
              config.forceSyntax !== 2) 
    {

      window[_gtag]('event', distance, {'event_category': config.category, 'event_label': config.label, 'non_Interaction': true});
